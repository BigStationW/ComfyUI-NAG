...
def sample_with_nag(
    ...
    samples = sampler.sample(
        ...
        cfg=cfg, nag_scale=nag_scale, nag_tau=nag_tau, nag_alpha=nag_alpha, nag_sigma_start=nag_sigma_start, nag_sigma_end=nag_sigma_end,
...
def sample_custom_with_nag(
        model, noise, cfg, nag_scale, nag_tau, nag_alpha, nag_sigma_start, nag_sigma_end, sampler, sigmas, positive, negative, nag_negative, latent_image, noise_mask=None, callback=None, disable_pbar=False, seed=None, latent_shapes=None, **kwargs):
    samples = samplers_sample_with_nag(
        model, noise, positive, negative, nag_negative,
        cfg, nag_scale, nag_tau, nag_alpha, nag_sigma_start, nag_sigma_end,
